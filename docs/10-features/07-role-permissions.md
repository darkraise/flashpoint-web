...
RBAC provides fine-grained permission management through a flexible role and
permission model. Administrators can create custom roles, assign specific
permissions, and control user access to features and resources.
...
- **Rules:** Cannot delete system roles (admin, user, guest) or roles with
  assigned users
