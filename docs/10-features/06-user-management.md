...
User management provides administrators with tools to create, view, update, and
delete user accounts, assign roles, and manage user activation status. The
system ensures at least one admin account exists.
