...
This directory contains historical migration files that have been consolidated
into the current migration system.
...
These archived files are kept for reference and historical documentation
purposes only. **They are no longer executed** by the migration system.
...
2. **Backward compatibility** - Existing databases are detected and marked as
   migrated
